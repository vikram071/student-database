...
void createAccount()
{
    ...
    printf("\t\t\tEnter Student's Current Attendance : ");
    scanf("%f", &stundentInformation.studentAttendance);
...
void displayInfo()
{
    ...
    printf("\n\n\t\t%-20s%-13s%-10s%-25s%-15s%-s\n", "Name", "ID", "Dept.", "Address", "Contact", "Attendance");
    printf("\t\t----------------------------------------------------------------------------------------");

    while (fread(&stundentInformation, sizeof(stundentInformation), 1, fileOne) == 1)
    {
        printf("\n\n\t\t%-20s%-13s%-10s%-25s%-15s%-.2f", stundentInformation.studentName, stundentInformation.studentId, stundentInformation.studentDept, stundentInformation.studentAddress, stundentInformation.studentContactNum, stundentInformation.studentAttendance);
    }
...
void updateInfo()
{
    ...
    while (fread(&studentInformation, sizeof(studentInformation), 1, fileOne) == 1)
    {
        if (strcmp(studentInformation.studentId, tempInformation.studentId) == 0)
        {
            ...
            {
                printf("\n\t\t\tEnter Student's Attendance to Update: ");
                scanf("%f", &tempInformation.studentAttendance);
                studentInformation.studentAttendance = tempInformation.studentAttendance;
...
void searchInfo()
{
    ...
    if (choice == 1)
    {
        ...
        while (fread(&studentInformation, sizeof(studentInformation), 1, fileOne) == 1)
        {
            ...
            {
                flag++;
                printf("\n\t\t\tStudent Name : %s\n\t\t\tStudent ID : %s\n\t\t\tStudent Dept. : %s\n\t\t\tStudent Address : %s\n\t\t\tStudent Contact No. : %s\n\t\t\tStudent Attendance : %.2f\n", studentInformation.studentName, studentInformation.studentId, studentInformation.studentDept, studentInformation.studentAddress, studentInformation.studentContactNum, studentInformation.studentAttendance);
            }
        }
        if (flag == 0)
        {
    ...
    else if (choice == 2)
    {
        ...
        while (fread(&studentInformation, sizeof(studentInformation), 1, fileOne) == 1)
        {
            ...
            {
                flag++;
                printf("\n\n\t\t%-20s%-13s%-10s%-25s%-15s%-.2f", studentInformation.studentName, studentInformation.studentId, studentInformation.studentDept, studentInformation.studentAddress, studentInformation.studentContactNum, studentInformation.studentAttendance);
            }
        }
        if (flag == 0)
        {
